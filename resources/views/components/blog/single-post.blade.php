                    ...
                    <div class="col-12">
                        <div class="blog-post border">
                            <div class="blog-post__img">
                                <a href="{{ route('single-post', $data->slug) }}"
                                    class="t-link blog-post__img-link w-100">
                                    <img src="{{ $data->thumbnail }}" alt="zolfin" class="w-100 img-fluid" />
                                </a>
                                <span
                            ...
                            <div class="blog-post__body">
                                        ...
                                        <li class="blog-post__footer-list t-mb-15 t-mr-15">
                                            <a href="/users/{{ $data->user->username }}"
                                                ...
                                                <span class="blog-post__author-img t-mr-8">
                                                    <img src="{{ $data->user->photo }}" alt="{{ $data->user->photo }}"
                                                        class="img-fluid" />
                                                </span>
                                ...
                                <p class="t-mt-30 t-text-heading">
                                    Curabitur at fermentum purus. Interdum et malesuada fames ac ante ipsum primis in
                                    faucibus. Mauris non nisl interdum, citudin neque sed, posuere elit. Vivamus ac
                                    tincidunt sapien. Aenean nec aliquet enim. Donec at dapibus enim. Integer et tur is
                                    vel turpis vehicula mattis. Class aptent taciti sociosqu ad litora torquent per
                                    conubia nostra, per inceptos himenaeosivam.
                                </p>
                            ...
                            <div id="comments" class="st-comments-area">
                                ...
                                <ul class="st-comments-list">
                                    <li>
                                        <div class="st-comments">
                                            <div class="st-comments__author ">
                                                <img src="assets/img/user-2.jpg" alt="SoftTech-IT"
                                        ...
                                        <ul class="st-comments__children">
                                            <li>
                                                <div class="st-comments">
                                                    <div class="st-comments__author">
                                                        <img src="assets/img/user.jpg" alt="SoftTech-IT"
                                                            class="img-fluid st-comments__author-img">
                                                    </div>
                                                    <div class="st-comments__body">
                                                        <ul class="st-comments__info t-mb-16">
                                    ...
                                    <li>
                                        <div class="st-comments">
                                            <div class="st-comments__author ">
                                                <img src="assets/img/user-3.jpg" alt="SoftTech-IT"
                                                    class="img-fluid st-comments__author-img">
                                            </div>
                                            <div class="st-comments__body">
                                                <ul class="st-comments__info t-mb-16">
                        ...
                        <ul class="t-list recent-post">
                                ...
                                <div class="recent-post__post row no-gutters">
                                    <div class="recent-post__img col-4">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/recent-post-1.png" alt="zolfin"
                            ...
                            <li class="recent-post__list">
                                <div class="recent-post__post row no-gutters">
                                    <div class="recent-post__img col-4">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/recent-post-2.png" alt="zolfin"
                                                class="img-fluid recent-post__img-is w-100" />
                                        </a>
                                    </div>
                                    <div class="recent-post__content col-8">
                            ...
                            <li class="recent-post__list">
                                <div class="recent-post__post row no-gutters">
                                    <div class="recent-post__img col-4">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/recent-post-3.png" alt="zolfin"
                                                class="img-fluid recent-post__img-is w-100" />
                                        </a>
                                    </div>
                                    <div class="recent-post__content col-8">
                            ...
                            <li class="recent-post__list">
                                <div class="recent-post__post row no-gutters">
                                    <div class="recent-post__img col-4">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/recent-post-4.png" alt="zolfin"
                                                class="img-fluid recent-post__img-is w-100" />
                                        </a>
                                    </div>
                                    <div class="recent-post__content col-8">

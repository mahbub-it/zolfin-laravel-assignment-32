                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                            ...
                            <ul class="t-list text-center text-md-left">
                                ...
                                <li class="t-mb-10">
                                    <a href="/service-details" class="t-link text-capitalize t-link--alpha">
                                        UX Research
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                            ...
                            <ul class="t-list text-center text-md-left">
                                <li class="t-mb-10">
                                    <a href="/blog" class="t-link text-capitalize t-link--primary t-link--alpha">
                                        blog
                                    </a>
                                </li>
                                <li class="t-mb-10">
                                    <a href="/process" class="t-link text-capitalize t-link--primary t-link--alpha">
                                        terms condition
                                    </a>
                                </li>
                                <li class="t-mb-10">
                                    <a href="/about" class="t-link text-capitalize t-link--alpha">
                                        legal info
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-6 col-lg-2 t-mb-30 mb-lg-0">
                            ...
                            <ul class="t-list text-center text-md-left">
                                <li class="t-mb-10">
                                    <a href="/contact" class="t-link text-capitalize t-link--primary t-link--alpha">
                                        online form
                                    </a>
                                </li>
                                <li class="t-mb-10">
                                ...
                                <li class="t-mb-10">
                                    <a href="/contact" class="t-link text-capitalize t-link--alpha">
                                        contact us
                                    </a>
                                </li>
                            </ul>

                                        ...
                                        <div class="data-wrapper d-flex mt-2 mt-lg-0">
                                            <div class="wrapper pr-5">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <small class="ml-2 text-gray d-none d-lg-block"><b>89.5%</b> of
                                                        20,000 Total</small>
                                                </div>
                                            </div>
                                            <div class="wrapper">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <small class="ml-2 text-gray d-none d-lg-block"><b>10.5%</b> of
                                                        20,000 Total</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between w-100">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-outline-secondary dropdown-toggle"
                                                        type="button" id="dateSorter" data-toggle="dropdown"
                ...
                <footer class="footer">
                    <div class="container-fluid clearfix">
                        ...
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> DreamWebdev <a
                                href={{ "https://www.dreamwebdev.com/bootstrap-admin-template/" }} target="_blank">Admin
                                Templates</a> from DreamWebdev.com</span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
